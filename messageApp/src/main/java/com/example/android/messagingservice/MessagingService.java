...
public class MessagingService extends Service {
    ...
    public static final String CHANNEL_ID = "auto";
    ...
    private void sendNotificationForConversation(Conversations.Conversation conversation) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            createNotificationChannelIfNotSet(this);
        }
    ...
    public static void createNotificationChannelIfNotSet(Context context) {
        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        assert notificationManager != null;
        NotificationChannel channelCheck = notificationManager.getNotificationChannel(CHANNEL_ID);
        if (channelCheck == null) {
            int importance = NotificationManager.IMPORTANCE_LOW;
            NotificationChannel notificationChannel = new NotificationChannel(CHANNEL_ID, "auto message test", importance);
